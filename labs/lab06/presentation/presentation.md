...
![Julia. Скрипт (2). Задача об эпидемии ($I(0) > I^*$)](img/3.png)
...
![Julia. Скрипт. Задача об эпидемии ($I(0) \leq I^*$)](img/4.png)
...
![Modelica. Модель. Задача об эпидемии ($I(0) \leq I^*$)](img/MOVar2.png)
